...
const CreatePage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      toast.success('Successfully creating new admin');
    } catch (error: any) {
          ...
          <div>
            <div className="flex items-center justify-between overflow-x-auto">
              ...
              >
                <ul>
                  <li>Dashboard</li>
                  <li>
                    <a href="/dashboard/admin-management">Admin Management</a>
                  </li>
                  <li>Create</li>
                </ul>
              </div>
            ...
            <div className="mt-5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-5 w-60 xl:grid-cols-2 xl:w-auto ">
                  <div
                    aria-label="Card"
